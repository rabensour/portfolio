...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary-900 text-white mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            <h3 className="font-heading font-bold text-xl mb-4 text-white">
              Cabinet Dentaire Dr Abensour
            </h3>
            <p className="text-secondary-300 mb-4">
              Votre sourire est notre priorité. Nous vous accueillons dans un
              environnement moderne et rassurant pour tous vos soins dentaires.
            </p>
            <div className="flex space-x-4">
              {/* Réseaux sociaux - à personnaliser avec les vrais liens */}
              <a
          ...
          <div>
            ...
            <div className="mt-4 p-3 bg-primary-900/30 rounded-lg border border-primary-800">
              <p className="text-sm text-primary-300">
                <span className="font-semibold">Urgences</span> acceptées tous
                les jours
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-secondary-300">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 mt-0.5 text-primary-400 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      {/* Barre inférieure - Copyright et mentions légales */}
      <div className="border-t border-secondary-800">
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-secondary-400 text-sm">
              © {currentYear} Cabinet Dentaire Dr Abensour. Tous droits
              réservés.
            </p>
